...
RailRoadArc::RailRoadArc(const Point3d & s, const Angle a, const Point2d & c, const Direction d)
	: start_(s), angle_(a), center_(c), dir_(d)
{
...
Direction 
RailRoadArc::GetDirection() const
{
	return dir_;
}
