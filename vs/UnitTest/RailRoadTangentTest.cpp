...
{
	RailRoadArc rra(Point3d(10, 10, 0), Degrees(180), Point2d(0, 10), Rotation::Clockwise);
...
{
	RailRoadArc rra(Point3d(20, 10, 0), Degrees(180), Point2d(10, 10), Rotation::Clockwise);
