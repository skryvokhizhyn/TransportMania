...
{
	RailRoadArc rra({ Point3d(0, 0, 0), Degrees(360), Point2d(10, 0) });
...
{
	RailRoadArc rra({ Point3d(0, 0, 0), Degrees(180), Point2d(0, 10) });
...
{
	RailRoadArc rra({ Point3d(0, 0, 0), Degrees(-90), Point2d(0, 10) });
